...
#LDLIBSOPTIONS=-Llib -L/usr/local/lib -static -lboost_thread -lboost_regex -lboost_date_time -lpthread -lboost_system
...
#LDLIBSOPTIONS=-Llib -L/lib64 -L/usr/lib64 -L/usr/local/lib -static -lboost_thread -lboost_regex -lboost_date_time 
# Build Targets
